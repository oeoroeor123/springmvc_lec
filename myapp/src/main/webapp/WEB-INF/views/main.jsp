...
<jsp:include page="./layout/header.jsp">
  ...
  <script>
    ...
    function loginForm() {
      document.getElementById('btn-login-form').addEventListener('click', (event) => {
        location.href='${contextPath}/main/login.form?url=' + location.href;
      })
    }
    ...
    function signupForm() {
      document.getElementById('btn-signup-form').addEventListener('click', (event) => {
        location.href='${contextPath}/main/signup.form';
      })
    }
  ...
  <script>
    ...
    function logout() {
      document.getElementById('btn-logout').addEventListener('click', (event) => {
        location.href='${contextPath}/main/logout.do';
      })  
    }
    logout();
  </script>
  ...
  <img src="${contextPath}/assets/images/animal2.jpg" width=300px, height=150px>
